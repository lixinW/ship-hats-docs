...
1. Provide sensitive variables
  ...
  Following is the list of sensitive variables that are required for the compliance to pass for your pipeline. You may consider adding them in your project's CI/CD variables.
...
- The following are required by, not compliance, but for the Webapp E2E template: 
...
1. Apply compliance framework
  ...
  > **Notes:** When using this end-to-end template:
