...
|Template|Description|Template Type|
|---|---|---|
|[Nexus IQ scan](https://sgts.gitlab-dedicated.com/wog/gvt/ship/ship-hats-templates/-/tree/main/templates#file-gitlab-ci-nexus-iq-scanyml)|This template allows you to perform nexus iq scan on archives or directories and optionally generate a CycloneDX SBOM file on archives or directories.|Modular Template
...
|[Aquasec Trivy scan](https://sgts.gitlab-dedicated.com/wog/gvt/ship/ship-hats-templates/-/tree/main/templates#file-gitlab-ci-aquasec-trivy-scanyml)|This template allows you to perform an Aquasec Trivy image scan and generate a Gitlab UI-compatible report, with an optional CycloneDX SBOM report, for an image in a .tar or .tar.gz format or from a remote image registry.|Modular Template
