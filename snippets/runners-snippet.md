...
If you are unable to find a suitable image in Pipeline COE, you may [raise a request](https://go.gov.sg/ship-hats-request) or if you find an image that can add on the tools that you require, you may edit the Dockerfile and raise an MR for platform team to review and approve. 
</details>
